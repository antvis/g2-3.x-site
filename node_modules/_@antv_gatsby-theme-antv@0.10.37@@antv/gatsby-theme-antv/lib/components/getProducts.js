...
exports.getProducts = ({ t, language, }) => {
    const products = [
        {
            title: 'G2',
            ...
            links: [
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "home" }),
                    title: t('产品首页'),
                    url: `https://g2.${ANTV_DOMAIN}/${language}`,
                },
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "pie-chart" }),
                    title: t('图表示例'),
                    url: `https://g2.${ANTV_DOMAIN}/${language}/examples`,
                },
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "read" }),
                    title: t('使用文档'),
                ...
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "history" }),
                    title: t('更新日志'),
                    url: `https://github.com/antvis/g2/blob/master/CHANGELOG.md`,
                    openExternal: true,
                },
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "github" }),
                    title: t('GitHub 仓库'),
        ...
        },
        {
            ...
            links: [
                ...
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "area-chart" }),
                    title: t('生成图表'),
                    url: `https://chartcube.alipay.com/guide`,
                    openExternal: true,
                },
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "yuque" }),
                    title: t('语雀社区'),
                    url: `https://www.yuque.com/chartcube`,
                    openExternal: true,
                },
                {
                    icon: react_1.default.createElement(antd_1.Icon, { type: "dingding" }),
                    title: t('钉钉服务群'),
