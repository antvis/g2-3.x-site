 ...
 */
    ...
    function simulateKeyEvent(target /*:HTMLElement*/, type /*:String*/,
                                ...
                                view /*:Window*/, ctrlKey /*:Boolean*/, altKey /*:Boolean*/,
     ...
     *      been used. The default value is 1.
     */
    function simulateUIEvent(target /*:HTMLElement*/, type /*:String*/, bubbles /*:Boolean*/,
                               cancelable /*:Boolean*/, view /*:Window*/, detail /*:int*/) /*:Void*/ {
    ...
    function simulateTouchEvent(target, type,
        ...
        if (isFunction(doc.createEvent)) {
            ...
            // fire the event
            target.dispatchEvent(customEvent);
        //} else if (isObject(doc.createEventObject)){ // Windows Mobile/IE, support later 
        } else {
