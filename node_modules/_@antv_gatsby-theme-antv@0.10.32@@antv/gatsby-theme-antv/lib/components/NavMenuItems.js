...
const NavMenuItems = ({ navs = [], path }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, navs.map((nav, i) => {
        ...
        return (react_1.default.createElement("li", { key: i, className: className }, nav.target === '_blank' ? (react_1.default.createElement("a", { href: href, target: "_blank", rel: "noopener noreferrer" }, title)) : (react_1.default.createElement(gatsby_1.Link, { to: href }, title))));
    })));
};
