...
const Banner = ({ coverImage, title, description, notifications, style = {}, className, video, showGithubStars = true, buttons = [], onCloseVideo, onPlayVideo, }) => {
  ...
  `;
    ...
    const renderButtons = buttons.map((button, i) => {
        ...
        return (react_1.default.createElement(ButtonLink, Object.assign({}, buttonProps, { className: classnames_1.default(Banner_module_less_1.default.buttonLink, Banner_module_less_1.default[button.type || ''], button.type === 'primary' ? 'primary-button' : 'common-button'), key: i, style: button.style }),
    ...
    if (video) {
        renderButtons.push(react_1.default.createElement("div", { key: "video", onClick: showVideo, className: Banner_module_less_1.default.videoButtonWrapper },
            react_1.default.createElement("div", { className: Banner_module_less_1.default.videoButton },
                react_1.default.createElement(antd_1.Icon, { type: "caret-right", className: Banner_module_less_1.default.videoButtonIcon, style: { fontSize: '16px', color: '#873BF4' } }),
